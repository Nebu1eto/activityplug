...
ください。[サーバの使い方](server-usage.ja.md)を参照してください。
...
--------------
 ...
 -  TypeScript から直接統合し、実行環境ごとの remote authority を設定
    する場合は[ライブラリの使い方](library-usage.ja.md)を参照して
    ください。
 -  GraphQL または HTTP クライアントを開発する場合は
    [サーバの使い方](server-usage.ja.md)を参照してください。
 -  Web アプリケーションを開発する場合は
    [ブラウザ統合](browser-integration.ja.md)を参照してください。
 -  サーバ固有の機能に依存する前に
    [アダプタと capability](adapters-and-capabilities.ja.md)を参照して
    ください。
