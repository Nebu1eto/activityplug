...
[English](authentication-and-sessions.md) | 한국어 |
[日本語](authentication-and-sessions.ja.md)
...
[0.1.0 인증 마이그레이션](migrations/0.1.0-authentication.ko.md)을
참고하십시오.
...
전체 저장소 표와 수명주기 요건은 [세션 저장소](session-storage.ko.md)를
참고하십시오.
...
---------
 ...
 -  [0.1.0 인증 마이그레이션](migrations/0.1.0-authentication.ko.md)
