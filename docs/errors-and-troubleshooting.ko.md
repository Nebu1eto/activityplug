...
[English](errors-and-troubleshooting.md) | 한국어 |
[日本語](errors-and-troubleshooting.ja.md)
...
지운 뒤 갱신 실패를 표시하십시오.
[브라우저 통합](browser-integration.ko.md#인증-복구)을
참고하십시오.
...
---------
 ...
 -  [서버 사용법](server-usage.ko.md)
 -  [브라우저 통합](browser-integration.ko.md)
 -  [인증 및 세션](authentication-and-sessions.ko.md)
