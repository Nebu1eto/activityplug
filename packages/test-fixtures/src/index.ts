...
export const accountMappingFixtures = {
  ...
  pleroma: {
    ...
    post: {
      id: "pleroma-900",
      uri: "https://pleroma.example/objects/pleroma-900",
      url: "https://pleroma.example/notice/pleroma-900",
      account: {
        id: "pleroma-109",
        username: "alice",
        acct: "alice",
  ...
  hollo: {
    account: {
      ...
      avatar: "https://hollo.example/avatar.png",
      header: "https://hollo.example/header.png",
      bot: false,
      locked: false,
      created_at: "2024-01-01T00:00:00.000Z",
      note: "<p>Hello from Hollo.</p>",
      followers_count: 10,
      following_count: 20,
      statuses_count: 30,
      fields: [{ name: "Website", value: "https://example.com", verified_at: null }],
    ...
    post: {
      id: "hollo-900",
      uri: "https://hollo.example/users/alice/statuses/hollo-900",
      url: "https://hollo.example/@alice/hollo-900",
      account: {
        id: "hollo-109",
        username: "alice",
        acct: "alice",
