...
The ActivityPlug project has the following rules for AI usage:
...
These rules apply only to outside contributions to ActivityPlug.  Maintainers
are exempt from these rules and may use AI tools at their discretion; they've
...
Please remember that ActivityPlug is maintained by humans.
...
ActivityPlug is written with plenty of AI assistance, and many maintainers
